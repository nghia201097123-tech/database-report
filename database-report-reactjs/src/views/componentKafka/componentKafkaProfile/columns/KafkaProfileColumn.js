...
class KafkaProfileColumns {
  constructor(handleChangeStatus, handleEdit, handleGroupIdManagement) {
    this.handleChangeStatus = handleChangeStatus;
    this.handleEdit = handleEdit;
    this.handleGroupIdManagement = handleGroupIdManagement;
  }
        ...
        render: (text, record) => (
          ...
          >
            <Button
              ...
              onClick={() => this.handleGroupIdManagement(record)}
            >
              Group ID
            </Button>
...
export default KafkaProfileColumns;
